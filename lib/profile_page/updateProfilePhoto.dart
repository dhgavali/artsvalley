...
class _UpdateProfileImageState extends State<UpdateProfileImage> {
  ...
  Widget build(BuildContext context) {
    var userImage = Provider.of<DatabaseService>(context,listen: false).userProfileImage;
    var userImageUrl = Provider.of<DatabaseService>(context,listen: false).userProfileImageUrl;
    return Scaffold(
      body: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Provider.of<DatabaseService>(context,listen: false).cropImage(context);
                        },
                      ),
                    ],
                  ),
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      MaterialButton(
                        ...
                        onPressed: () {
                          Provider.of<EditProfile>(context,listen: false).selectProfileImageType(context);
                        },
                      ),
                      MaterialButton(
                        child: Text(
