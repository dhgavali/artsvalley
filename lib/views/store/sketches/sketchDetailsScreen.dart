...
import 'package:artsvalley/views/store/sketches/sketchwithimage.dart';
...
class SketchDeatailsScreen extends StatelessWidget {
  final SketchesProducts product;

  const SketchDeatailsScreen({Key key, this.product}) : super(key: key);
  @override
            ...
            SizedBox(
              ...
              child: Stack(
                children: [
                  ...
                  SketchWithImage(product: product),
                ],
              ),
            ),
          ],
